<form id="fileimagesize" >
	<div class="form-group col-md-6">
		...
		<input type="number" id="fileimagesize-minwidth" name="my_element[validateOption][fileimagesize][minwidth]" class="form-control"/>
	</div>  

	<div class="form-group col-md-6">
		<label>Max width:</label>
		<input type="number" id="fileimagesize-maxwidth"  name="my_element[validateOption][fileimagesize][maxwidth]" class="form-control"/>
	</div>

	<div class="form-group col-md-6">
		<label>Min height:</label>
		<input type="number" id="fileimagesize-minheight" name="my_element[validateOption][fileimagesize][minheight]" class="form-control"/>
	</div>

	<div class="form-group col-md-6">
		<label>Max height:</label>
		<input type="number" id="fileimagesize-maxheight" name="my_element[validateOption][fileimagesize][maxheight]" class="form-control"/>
	</div>

<form id="dbnorecordexists" >
	<div class="form-group col-md-6">
		...
		<input type="text"  id="dbnorecordexists-table" name="my_element[validateOption][dbnorecordexists][table]" class="form-control" />
	</div>
	    
	<div class="form-group col-md-6">
		<label for="min">Field:</label>
		<input type="text"  id="dbnorecordexists-field" name="my_element[validateOption][dbnorecordexists][field]" class="form-control" />
	</div> 

	<div class="form-group col-md-6">
		<label for="min">Adapter:</label>
		<input type="text" id="dbnorecordexists-adapter" name="my_element[validateOption][dbnorecordexists][adapter]" class="form-control" />
	</div>  

	<div class="form-group col-md-6">
		<label for="min">Exclude:</label>
		<input type="text" id="dbnorecordexists-exclude" name="my_element[validateOption][dbnorecordexists][exclude]" class="form-control" placeholder="field:name,value:name"/>
	</div>

	<div class="form-group col-md-6">
		<label for="min">Schema:</label>
		<input type="text" id="dbnorecordexists-schema" name="my_element[validateOption][dbnorecordexists][schema]" class="form-control" />
	</div>

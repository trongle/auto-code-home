<form id="dbrecordexists">
	...
	<div class="form-group col-md-6">
		...
		<input name="my_element[validateOption][dbrecordexists][exclude]" id="dbrecordexists-exclude" class="form-control" placeholder="field:name,value:name"/>
	</div>

	<div class="form-group col-md-6">
		<label for="min">Schema:</label>
		<input name="my_element[validateOption][dbrecordexists][schema]" id="dbrecordexists-schema" class="form-control" />
	</div>
